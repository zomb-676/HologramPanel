...
value class HologramColorARGB private constructor(val color: Int) {
    ...
    fun red(r: Int) = HologramColorARGB(color or (0xff shl RED_SHIFT) and (r shl RED_SHIFT))
    fun green(g: Int) = HologramColorARGB(color or (0xff shl GREEN_SHIFT) and (g shl GREEN_SHIFT))
    fun blue(b: Int) = HologramColorARGB(color or (0xff shl BLUE_SHIFT) and (b shl BLUE_SHIFT))
    fun alpha(a: Int) = HologramColorARGB(color or (0xff shl ALPHA_SHIFT) and (a shl ALPHA_SHIFT))
